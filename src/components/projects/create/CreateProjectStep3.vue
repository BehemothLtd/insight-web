        ...
        <table class="table b-table">
          ...
          <tbody>
            ...
            >
              <td>
                <FormValidator
                  :name="`projectAssignees.${index}.userId`"
                  required
                >
                  <el-select-v2
              ...
              <td>
                <FormValidator
                  :name="`projectAssignees.${index}.developmentRoleId`"
                  required
                >
                  <el-select-v2
              ...
              <td>
                <FormValidator
                  :name="`projectAssignees.${index}.active`"
                  required
                >
              ...
              <td>
                <FormValidator
                  :name="`projectAssignees.${index}.join_date`"
                  required
                >
                  <DatePicker
